...
describe("Crop", () => {
  ...
  describe("associateCompanion - No self-companion", () => {
  ...
  describe("associateCompanion - Forbidden companions", () => {
  ...
  describe("domain events", () => {
    test("emits CompanionAssociated event when associating a companion", () => {
      ...
      expect(events[0]).toBeInstanceOf(CompanionAssociated);
      expect((events[0] as CompanionAssociated).cropName).toBe("tomato");
      expect((events[0] as CompanionAssociated).companionName).toBe("basil");
    });
